...
export const RecipeData: Recipe[] = [
    ...
    "segments": [
      {
        ...
        "steps": [
          ...
          {
            "instruction": "Punch down dough. Knead or roll out the air bubbles. Shape into two oblong loaves. Place on a cookie sheet that has been greased and dusted with corn meal. Cover with a towel and let rise for about 40 minutes total. Turn on your oven to preheat to 425, 20 minutes before you want to start baking."
          },
          {
            "instruction": "Before baking, make 3-4 slices across your loaves with a sharp knife. You can slice someone’s initials in the top of the loaves, if it’s their birthday … just for fun. Bake for 20-23 minutes until light brown. Cool on wire racks. "
          }
        ],
        "description": "This is the family’s basic white bread. It has a fairly soft crust but still the texture and substance of an oblong loaf baked outsidea bread pan so it gets nicely baked sides. You can use a mix of white and whole wheat flours, though you run the risk of being asked why you’re trying to make comfort food healthy. ",
    ...
    "segments": [
      {
        ...
        "steps": [
          {
            "instruction": "Mix flour, salt, and baking powder. Cut in Crisco with a pastry blender.Honestly just make a double batch. Everyone will thank you.",
            "ingredients": [
              "2 cups flour",
              "1 t salt",
              "1 t baking powder",
          ...
          {
            "instruction": "2021: If you have time, wrap the dough in wax paper and let it sit on the counter for an hour. This makes the dough softer, the tortillas a little easier to roll out and possibly yummier. But if you’re in a rush, you can just continue directly to rolling out your tortillas. Divide dough into 10 pieces. Roll thin on floured surface. Drop onto hot ungreased griddle. Allow to cook/bake until freckled (30-50 seconds). Turn over and repeat. "
          }
        ],
        "description": "Warning: There’s one big problem with introducing homemade tortillas to your family: no one is happy eating store-bought tortillas any longer. Everyone in my family agrees that store-bought tortillas have a funny texture and some odd chemically flavor. It’s hard to compare tortillas baked who knows when in a factory and packaged in plastic for more than a couple days with fresh, soft, homemade tortillas, warm from the griddle.\n\n2021: Please make extra tortillas. I usually double this batch. Everyone likes to have at least one last tortilla drizzled with honey as a dessert. And if you have leftovers, keep them in a Ziploc in the fridge, in order to make scrambled eggs burritos tomorrow for breakfast or quesadillas for lunch. Just warm your tortillas oh-so-briefly in the microwave to soften them up. Alternately, you can use a leftover tortilla to make a tortilla pizza. A little pizza sauce and some parmesan on top. Then warm it on a griddle, in the microwave, or briefly in the toaster oven. With so many possibilities for leftover tortillas, maybe you should make a triple batch to begin with.",
        "outro": "Homemade tortillas make taco night special --less frequent than we would like, but worth the wait."
      }
    ]
  },
  {
    ...
    "segments": [
      {
        ...
        "steps": [
          ...
          {
            "instruction": "Add liquids to flour mixture. Beat 2 minutes scraping bowl occasionally. Add the additional 2 ½ cups flour - ¼ cup at a time until a soft dough forms. Knead 8-10 minutes. Cover and let rest 10 minutes. Yes. just 10",
            "ingredients": [
              "2 1/2 cups flour"
            ]
          },
          {
            "instruction": "Divide dough into 24 pieces. Shape into balls and place in a greased 9x13 pan. (6 rows of 4 small buns) Cover and let rise about 30 minutes or until double in size. You can halve the recipe and bake an 8-inch square pan full but, honestly, just make the bigger batch. If you have any leftovers, these make good breakfast carbs the next morning, unless someone has stolen them for a midnight snack."
          },
          {
            "instruction": "Bake in preheated oven at 375 for 20 minutes or until light brown. You can brush the tops of the warm rolls with a little butter if you wish because the true healthy eaters probably won’t be eating these shamelessly unnecessary white carbs."
          }
        ],
        "description": "For decades I avoided making dinner rolls. I just put out homemade bread and, of course, no one complained. Then there was that cool autumn evening when I wanted soup but had no bread in the house. Usually we opt for biscuits, but I really wanted something soft and yeasty. Guess what! Dinner rolls don’t have a long rising stage. They go from “wish I had that” to “warm and yummy” amazingly quickly. So don’t wait until you’re 50-something to give this recipe a try. \n\n2021: When COVID-19 forced us all to venture to grocery stores as seldom as possible, I realized that this dinner roll recipe makes great hamburg and hotdog buns. No need to run quick to the grocer to pick up fresh buns; make them from scratch. The result is a soft, slightly sweet and very pleasant white-carb-bun for your grilled meat or un-meat, barbecue,pulled pork, brats, or other sandwich creations. These are more substantial and flavorful than the mushy, flavorless store-bought bun varieties which are nothing more than a way to keep your topping together without getting too much ketchup on your fingers.Using this recipe, divide your dough into 12 portions. You can shape these portions into hamburg or hotdog bun shapes (or some of each) and arrange them in a greased 9x13 pan. When your bun shapes have risen and before you put them in the oven to bake, press them down a little so that the buns are wider and shorter (and easier to load up and still fit into your mouth). Enjoy! ",
        "outro": "If you bake enough bread to regularly sustain your family, then it will be easy to offer this basic comfort to others when needed. "
      }
    ]
  },
  {
    ...
    "segments": [
      {
        ...
        "steps": [
          ...
          {
            "instruction": "Mix all ingredients in a large bowl in the order given, until moist.Turn the batter-dough into your bread pan. This was originally called “Beer Bread” but we so seldom have beer in the house, we were forced into making Soda Bread. (I’ve even made it with root beer, when that was the only soda I had in the house.)",
            "ingredients": [
              "3 ½ cups flour",
              "3 ½ t baking powder",
              "1 t salt",
  ...
  },
  {
    ...
    "segments": [
      {
        "description": "Mix a cheese sauce variation of the white sauce with your favorite cooked pasta (makes enough sauce for one pound of dry pasta). Add sprinkles of granulated dried onion, garlic powder, black pepper, and dried basil, and possibly a dash of hot sauce to the cheesy sauce. Add cooked bacon bits, because how could bacon not make homemade mac & cheese be amazing?",
        ...
        "steps": [
          {
            ...
            "ingredients": [
              "1 part Rice to 2 parts water to 1/2 t salt."
            ]
          },
          {
  ...
  },
  {
    ...
    "segments": [
      ...
      },
      {
        ...
        "description": "\n\nLegal Cheats: Mix dry stuff in bowl #1 and wet stuff in bowl #2 the night before (storing the liquids in fridge). Wait until morning to combine (which only takes 40 seconds and can be done easily while yawning and before your eyes have completely adjusted to the kitchen light). \n\nIllegal Cheats: Do not cook up pancakes the night before if you want warm ones for breakfast. If you try to microwave them back to life, they’ll get soggy. If you think the toaster is a good option, … just buy the frozen ones. \n\nUp early? Mix up the batter and let it sit while you take a shower. This relaxes the batter. You may not have known that the batter was stressed to begin with, but letting the batter be bored for a few minutes seems to make for friendlier pancakes. Resist stirring the batter again when you start frying cakes. Too much stirring annoys the batter. Happy batter makes happy pancakes. ",
        "outro": "“He who goes to bed hungry dreams of pancakes.”"
      },

    ]
  },
  {
    "title": "Fabulous and Funky Filled French Toast",
    "originalBookID": 2,
    "recipeNumber": 2,
    "preparationTime": "20 minutes",
    "segments": [
      {
        "intro": "I have long suspected that French toast was someone’s idea of how to get bleary-eyed children to eat old bread for breakfast. JJ still thought this until we came up with this fabulous recipe and its funky creative options.",
        "steps": [
          {
          ...
          {
            "instruction": "Make 4 sandwiches, each with 2 slices of bread, spread in between with 1 oz of cream cheese each",
            "ingredients": [
              "4 oz. cream cheese",
            ]
          },
        ...
        "reviews": {
          ...
          "JJ": "If I gotta eat old bread, this is it."
        },
      },
      {
        "steps": [
          ...
          {
            "instruction": "The Bread. \n\tI haven't met a good bread that didn't work. Try cinnamon swirl, sour dough, cocoa, ryes, or extra thick slices for a change up.",
          },
          {
    ...
    "segments": [
      {
        ...
        "reviews": {
          "AJ": "The waffle dents let you hold more chocolate spread.",
          "NQ": "Grandma lets us put one chocolate chip in each waffle square.",
          "JJ": "Not as good as pancakes."
        },
      },
    ]
  },
  ...
  },
  {
    ...
    "originalBookID": 2,
    "recipeNumber": 20,
    "preparationTime": "15-20 minutes prep; hour of fun",
    "segments": [
      {
    ...
    "segments": [
      {
        ...
        bulletList: {
          ...
          list: [
            "Solo in a bowl with some of the juice ladled around it.",
            "With vanilla Greek yogurt",
            "With a small amount of cream poured around the edges",
            "Sprinkled with chopped pecans or walnuts",
            "Topped with a scopp of yesterday's Groovy granola",
          ]
        },
        "reviews": {
  ...
  },
  {
    ...
    "originalBookID": 2,
    "recipeNumber": 22,
    "preparationTime": "20 minutes the night before; 1 minute in the morning",
    "segments": [
      {
        "intro": "It's apple pie filling - warm, cinnamony, fruity sweetness. You'll be making this for every 'need some comfort' occasion.",
        "steps": [
          {
            instruction: "The basic recipe makes 3 cups of warm apple yumminess.",
          },
          {
            "instruction": "Lightly butter the inside of your 4 quart crock pot.",
          },
          {
            instruction: "Prepare the apples. Peel and core and chop enough apples.",
            ingredients: [
              "4 cups of apples (chopped and peeled)",
            ]
          },
          {
            instruction: "Mix into the apples.",
            ingredients: [
              "1/2 cup brown sugar",
              "1 t cinnamon",
              "1 t vanilla",
              "1/4 - 1/2 cup apple juice, apple cider, or water, if you think your apples are on the dry side",
          ...
          {
            instruction: "Serving:\nYou will not instructions once you get up and smell this pot of yum. But if you need some inspiration to stop eating directly from the crock and share this with someone else in the family, here you go."
          },
          {
            instruction: "Ladle Apple Compote on top of anyh cooked grains: oatmeal, cream of wheat, or R&B (rice and barley). \nServe with a dollup of yogurt. \nServe over Pan Crepes, Pancakes, or Dad's Best Waffles. \nLadle into a bowl and sprinkle with Grovy Granola."
          }
        ],
        "reviews": {
        ...
        bulletList: {
          header: "Sweet N Sour Apple Sausage Casserole",
          list: [
            "Create the apple compote above",
            "Add 1/2 cup chopped sauteed onion",
            "1 packaged chopped smoked kielbasa",
            "1 small can of drained sauerkraut (trust me it will be okay)",
            "1 t Dijon mustard (optional)",
            "Shortly before serving, stir in 1/2-1 cup shredded cheddar. Serve warm.",
          ]
        },
        outro: "If Eve had cooked that apple like this ..., Adam would never have complained.",
      },
    ],
  },
  {
    ...
    "segments": [
      {
        ...
        bulletList: {
          ...
          list: [
            "ORANGE Juice + diced apple + sliced banana + peeled and chopped kiwi",
            "ORANGE Juice + mandarin oranges + peeled and chopped honey dew melon + blue berries + ",
            "ORANGE Juice + strawberries + green grapes + sliced banana",
            "APPLE Juice + diced apple + canned pineapple chunks",
            "APPLE Juice + peeled and chopped cantaloupe + red grapes",
          ]
        },
      },
      {
        bulletList: {
          header: "Topping it off. Feel free to put any of these or other inspirations on top of your personal fruit soup.",
          list: [
            "coconut flakes",
            "yogurt",
            "cinnamon sugar",
      ...
      },
      {
        ...
        outro: "Two out of three kids insist that texture is not a flavor.\nAh, I see you are smart: one out of three kids must have foods of appealing textures. Survival tip: many things can be made into smoothies.",
      },
    ],
  },
  {
    "title": "Real Worth-it Oatmeal",
    "originalBookID": 2,
    "recipeNumber": 24,
    ...
    "segments": [
      {
        ...
        steps: [
          ...
          {
            instruction: "Mix together in a microwavable bowl. Cook in microwave for 1-2 minutes.",
            ingredients: [
              "1/2 cup rolled oats (not instant, not chopped, not quick cook",
            ]
          }
        ],
      ...
      },
      {
        steps: [
          {
            instruction: "Mix together in a mircowavable bowl. Cook on high in microwave for 1-2 minutes. Alternatively, pour liquid in a pot and cook over medium heat on the stovetop. Once it barely begins to bubble pour in the dry ingredients. Reduce heat to medium-low and stir while the enitre mixture bubbles for about 1-2 minutes.",
            ingredients: [
              "1/2 cup rolled oats",
              "2 t flax seed meal",
              "1 T oat bran",
        ...
        bulletList: {
          header: "The yummy topping combinations are almost endless. Start with some of these.",
          list: [
            "brown sugar or honey",
            "butter or cream/milk",
            "raisins or dried cherries or cranberries",
            "banana slices or apple slices or berries",
            "chopped walnuts",
            "chocolate chips",
            "all of the above",
          ],
      ...
      },
      {
        ...
        outro: "'You have to eat oatmeal or you'll dry up. Everybody knows that.' - Kay Thompson, author of the Eloise books",
      },
    ],
  },
  {
    "title": "Rice and Barley",
    "originalBookID": 2,
    "recipeNumber": 25,
    "preparationTime": "4-10",
    "segments": [
      ...
      },
      {
        steps: [
          {
            instruction: "For JJ (Savory - choose a list of ingredients)",
            ingredients: [
              "Shredded cheese and bacon bits",
              "Crumbled feta cheese, basil, olive oil, and oregano",
          ...
          {
            instruction: "For Gramma and the rest of us (choose one)",
            ingredients: [
              "Sweet R&B",
              "Butter and brown sugar",
              "Pancake syrup (with sliced banana)",
    ...
    "segments": [
      {
        ...
        bulletList: {
          ...
          list: [
            ...
            "some fresh cilantro",
            "some deep fried onion bits",
          ]
        },
      },
      {
        bulletList: {
          header: "Noodles\nIn almost every house there is a pasta lover.",
          list: [
    ...
    "segments": [
      {
        ...
        steps: [
          ...
          {
            instruction: "Cooking up\nFree a tube of polenta from its plastic casing. Using a sharp knife cut slices of polenta between 1/2 and 3/4 inches thick. Heat a small amount of vegetable oil in a non-stick skillet. Sauté the polenta patties, browning both sides slightly.",
            ingredients: [
              "1 Palenta tube",
            ]
          },
      ...
      },
      {
        ...
        outro: "'A rose by any other name smells as sweet.'' But if you label it 'flaming love blossom,' you'll sell twice as many!",
      },
    ],
  },
  {
    "title": "Spectacular Spuds",
    "originalBookID": 2,
    "recipeNumber": 28,
  ...
  },
  {
    ...
    "segments": [
      ...
      },
      {
        steps: [
          {
            instruction: "Optional beginnings, Add one or more of these to your fry pan and saute in the oil or until lightly browned or softened.",
            ingredients: [
              "2 T oil",
              "1/2 chopped cooked ham",
              "1/4 cup frozen peas",
              "1/2 cup finely chopped carrot",
              "1/4 cup finely chopped celery",
              "1/4 cup leftover cooked meat",
            ]
          },
          {
        ...
        bulletList: {
          ...
          list: [
            "ham + peas + cheddar cheese",
            "leftover chicken + celery + soy sauce",
            "bacon bits + corn + ketchup",
      ...
      },
      {
        steps:[
          ...
          {
            instruction: "In a 4 cup Pyrex-type pitcher, melt butter in the microwave.",
            ingredients: [
              "2 T unsalted butter",
            ]
          },
          {
            instruction: "Whisk in flour and microwave 30 seconds",
            ingredients: [
              "1/4 cup flour",
            ]
          },
          {
            instruction: "Whisk in milk and microwave 2-4 minutes, stirring every minute and scraping the flour goop bits from the edges of the bottom where they inevitably glump up. This mix should thicken up into a creamy white sauce.",
            ingredients: [
              "2 cups milk",
            ]
          },
          {
            instruction: "Add nutmeg, onion powder, and black pepper. Then stir in shredded cheddar (or some combination of leftover cheese bits from the depths of your cheese drawer, assuming they do not have anything growing on them). Stir until melty.",
            ingredients: [
              "dash of nutmeg",
    ...
    "segments": [
      {
        ...
        steps: [
          ...
          {
            instruction: "Knead until dough is not sticky but still quite soft. Put in a greased bowl to rise 1 hour."
          },
          {
          ...
          {
            instruction: "Bake at 375F for 20-25 minutes.",
          },
          {
            instruction: "Pour, spread, or smear on the Amaze-a Glaze below.",
          }
      ...
      },
      {
        steps: [
          {
            instruction: "Amaze-a Glaze\n Mix the following",
            ingredients: [
              "1 T softened unsalted butter",
              "1 1/2 cups powdered sugar",
              "1 t vanilla",
              "1-3 t milk to get your right consistency (less milk will let you spread it on thickly. More milk lets you pour it on and enjoy the glaze dripping off the edges.)"
            ]
          },
          {
  ...
  {
    "title": "Crustless/Curseless Quiche",
    "originalBookID": 2,
    "recipeNumber": 31,
    ...
    "segments": [
      {
        ...
        steps: [
          ...
          {
            instruction: "The crust\nSince this is a crustless quiche. No crust. Proceed to next step.",
          },
          {
            instruction: "Grease a 10-inch pie plate. (with steps this easy, you can do it in your sleep.)",
          },
          {
            instruction: "In a medium bowl mix shisk together",
            ingredients: [
              "1/2 cup flour",
              "1/2 t baking powder",
              "1 1/2 cups milk",
          ...
          {
            instruction: "Pour the mixture into your pie pan. Sprinkle some shredded cheese on top.",
            ingredients: ["Shredded cheese of choice"]
          },
          {
    ...
    "segments": [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            ingredients: [
              "1 cup shredded cheddar + 1/2 cup cooked chopped broccoli",
              "1/2 cup shredded mozzarella + 1/2 cup chopped pepperoni",
              "1/2 cup cheddar + 1 cup fried breakfast sausage crumbles",
              "1/2 cup sauteed onions, green peppers, and mushrooms",
              "1/2 cup cheddar + 1 cup chopped cooked potato + 1/2 cup fried bacon bits",
              "1/2 cup cheddar + chopped cooked ham",
            ]
          },
          {
      ...
      },
      {
        steps: [
          {
            instruction: "Mom's Pie Crust makes 2 9-inch pie crusts.",
          },
          {
            instruction: "Mix together in a bowl.",
            ingredients: [
  ...
  {
    "title": "The Ultimate Cheater Breakfast",
    "originalBookID": 2,
    "recipeNumber": 33,
...
export const BookData: Book[] = [
  ...
  },
  {
    ...
    id: 2,
    imageLink: "",
    intro: "For JJ. Happy Birthday! May you always have the option of enjoyhing delicious breakfasts and someone good to share them with.",
    edition: 2,
  },
  {
    title: "Soup-er Inspirations",
    id: 3,
    imageLink: "",
    intro: "A Soup-er Tour of Flavors. At Jason's request, I'm putting together another family cookbook. This time we are exploring soups that are family favorites or that used to be family favorites, and we're including some newer yummy options, too. I have for my entire cooking life made soups with as free spirit and almost no measuring cups whatsoever, so this cookbook has forced me to at least estimate my ingredients. Consider these recipes as guidelines for your own soup creativity. Soups almost more than any other meal option are one-pot creations to be adjusted depending on your mood, what you actually have in the pantry or fridge, and which ingredients you need to avoid for your particular soup slurpers. Enjoy the adventure! Love and hugs, Mom",
    edition: 1,
  },
  {
